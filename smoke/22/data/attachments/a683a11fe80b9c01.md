...
- Location: /home/runner/work/booking-app/booking-app/src/features/ui/hotel-room.ui.spec.ts:19:7
...
Error: locator.click: Error: strict mode violation: locator('.card:has(.card-title:has-text("Single")) .btn-primary') resolved to 2 elements:
    1) <a class="btn btn-primary" href="/reservation/1?checkin=2025-04-28&checkout=2025-04-29">Book now</a> aka locator('div').filter({ hasText: /^£850 per nightBook now$/ }).getByRole('link')
    2) <a class="btn btn-primary" href="/reservation/4?checkin=2025-04-28&checkout=2025-04-29">Book now</a> aka locator('div').filter({ hasText: /^£900 per nightBook now$/ }).getByRole('link')

Call log:
  - waiting for locator('.card:has(.card-title:has-text("Single")) .btn-primary')

    at RoomsPage.selectRoom (/home/runner/work/booking-app/booking-app/src/ui/pages/rooms.ts:11:95)
    at /home/runner/work/booking-app/booking-app/src/features/ui/hotel-room.ui.spec.ts:47:25
    at /home/runner/work/booking-app/booking-app/src/features/ui/hotel-room.ui.spec.ts:45:7
```
...
- text:  WiFi  TV  Safe £850 per night
- link "Book now":
  - /url: /reservation/1?checkin=2025-04-28&checkout=2025-04-29
- img "Single Room"
...
- link "Book now":
  - /url: /reservation/2?checkin=2025-04-28&checkout=2025-04-29
- img "Single Room"
- heading "Single" [level=5]
- paragraph: Please enter a description for this room
- text: £900 per night
- link "Book now":
  - /url: /reservation/4?checkin=2025-04-28&checkout=2025-04-29
